...
struct BridgeSeal {
    ...
    private static let infoClientToHost = "Longwave-CB-v1 client->host"
    private static let infoHostToClient = "Longwave-CB-v1 host->client"
    private static let infoClientToHostStream = "Longwave-CB-v1 client->host stream"
    private static let infoHostToClientStream = "Longwave-CB-v1 host->client stream"
