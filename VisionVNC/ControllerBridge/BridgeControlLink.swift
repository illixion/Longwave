...
final class BridgeControlLink {
    ...
    private let log = Logger(subsystem: "com.illixion.VisionVNC", category: "BridgeControlLink")
    private let queue = DispatchQueue(label: "com.illixion.VisionVNC.bridge.control")
