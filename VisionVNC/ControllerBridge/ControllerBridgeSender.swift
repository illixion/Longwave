...
//
//  visionOS half of the VisionVNC Controller Bridge. While a foveated PCVR
...
//  (see the PCVR design notes in VisionVNC-PCVR-Host/docs/). Verified on device — real
...
final class ControllerBridgeSender {
    ...
    private let log = Logger(subsystem: "com.illixion.VisionVNC", category: "ControllerBridge")
