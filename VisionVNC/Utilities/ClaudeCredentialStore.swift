...
enum ClaudeCredentialStore {
    ...
    private static let service = "com.illixion.VisionVNC.claudeOAuthCredential"
    private static let log = Logger(subsystem: "com.illixion.VisionVNC", category: "ClaudeCredentials")
