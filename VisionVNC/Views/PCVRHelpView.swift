...
struct PCVRHelpView: View {
            ...
            VStack(alignment: .leading, spacing: 30) {
                ...
                topic("What you need", rows: [
                    Row("pc", "A Windows PC with an NVIDIA RTX card",
                        "Running the VisionVNC Windows Companion, with PCVR started. It installs the streaming host for you the first time."),
    ...
    private var foveation: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            tracking at all. VisionVNC supplies it, which is why a given PC can hold a higher \
